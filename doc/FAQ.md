...
```
org.apache.ibatis.binding.BindingException: Invalid bound statement (not found): org.golfworld.db.dao.XXXX
```
...
The error may involve org.golfworld.db.dao.LitemallSystemMapper.selectByExample-Inline
