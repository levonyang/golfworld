...
import org.golfworld.admin.task.GrouponRuleExpiredTask;
import org.golfworld.admin.util.AdminResponseCode;
...
import org.golfworld.db.domain.GrouponRules;
import org.golfworld.db.service.GoodsService;
import org.golfworld.db.service.GrouponRulesService;
import org.golfworld.db.service.GrouponService;
...
public class AdminGrouponController {
    ...
    public Object listRecord(String grouponRuleId,
        ...
        List<Groupon> grouponList = grouponService.querySelective(grouponRuleId, page, limit, sort, order);
    ...
    public Object update(@RequestBody GrouponRules grouponRules) {
        ...
        GrouponRules rules = rulesService.findById(grouponRules.getId());
        if(rules == null){
