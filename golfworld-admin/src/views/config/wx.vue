    ...
    >
      <el-tabs tab-position="left">
        <el-tab-pane label="首页配置">
          ...
          <el-form-item label="分类栏目商品显示数量" prop="litemall_wx_catlog_product">
            <el-input v-model="dataForm.litemall_wx_catlog_product" />
          </el-form-item>
        </el-tab-pane>
