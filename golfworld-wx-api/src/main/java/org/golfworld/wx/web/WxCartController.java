...
import static org.golfworld.wx.util.WxResponseCode.GOODS_NO_STOCK;
import static org.golfworld.wx.util.WxResponseCode.GOODS_UNSHELVE;
...
public class WxCartController {
    ...
    public Object checkout(@LoginUser Integer userId, Integer cartId, Integer addressId, Integer couponId, Integer userCouponId, Integer grouponRulesId) {
        ...
        for(CouponUser couponUser : couponUserList){
            Coupon coupon = couponVerifyService.checkCoupon(userId, couponUser.getCouponId(), couponUser.getId(), checkedGoodsPrice);
            if(coupon == null){
                continue;
            }
