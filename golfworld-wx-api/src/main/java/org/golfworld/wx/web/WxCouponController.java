...
import org.golfworld.db.domain.Cart;
...
import org.golfworld.wx.vo.CouponVo;
import org.golfworld.wx.util.WxResponseCode;
...
public class WxCouponController {
    ...
    public Object selectlist(@LoginUser Integer userId, Integer cartId, Integer grouponRulesId) {
        ...
        for (CouponVo cv : couponVoList) {
            Coupon coupon = couponVerifyService.checkCoupon(userId, cv.getCid(), cv.getId(), checkedGoodsPrice);
