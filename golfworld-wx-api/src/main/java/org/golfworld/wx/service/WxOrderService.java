...
public class WxOrderService {
    ...
    public Object submit(Integer userId, String body) {
        ...
        if (couponId != 0 && couponId != -1) {
            Coupon coupon = couponVerifyService.checkCoupon(userId, couponId, userCouponId, checkedGoodsPrice);
            if (coupon == null) {
                return ResponseUtil.badArgumentValue();
            }
    ...
    public Object payNotify(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (groupon != null) {
            GrouponRules grouponRules = grouponRulesService.findById(groupon.getRulesId());
            ...
            List<Groupon> grouponList = grouponService.queryJoinRecord(groupon.getGrouponId());
            if (groupon.getGrouponId() != 0 && (grouponList.size() >= grouponRules.getDiscountMember() - 1)) {
                ...
                Groupon grouponSource = grouponService.queryById(groupon.getGrouponId());
